    ...
    public void addEvent(Event event) {
        ...
        try (CSVWriter writer = new CSVWriter(new FileWriter(this.fileName, true))) {
            ...
            if (event instanceof SingularEvent) {
                ...
                record = new String[]{singularEvent.getDate().toString(), singularEvent.getDescription(), singularEvent.getCategory().toString()};
            } else if (event instanceof AnnualEvent) {
                AnnualEvent annualEvent = (AnnualEvent) event;
                record = new String[]{annualEvent.getMonthDay().toString(), annualEvent.getDescription(), annualEvent.getCategory().toString()};
            } else {
