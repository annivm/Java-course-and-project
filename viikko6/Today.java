...
public class Today {
    ...
    private static boolean isSameDate(LocalDate someDate, LocalDate otherDate) {
        ...
        private static void printFeedback(int key){
            switch (key) {
                case 1:
                    System.out.println("Please use form: primary/secondary for the category");
                        break;
                case 2:
                    System.out.println("Please use two arguments (form: java Today.java --mm-dd primary/secondary)");
                        break;
                case 3:
                    System.out.println("Please use form: --mm-dd for the date");
                        break;
                    default:
                        break;
                }
        ...
        public static void main(String[] args) {
            ...
            // komentoriviargumenttien lukeminen
            if(args.length < 2){
                printFeedback(2);
                return;
            }
            ...
            try {
                dateToFind = LocalDate.parse(2000 + args[0], DateTimeFormatter.ofPattern("yyyy--MM-dd"));
            ...
            try {
                categoryToFind = new Category(null, null);
                categoryToFind = Category.parse(args[1]);
                if (categoryToFind.getPrimary() == null || categoryToFind.getSecondary() == null){
                    printFeedback(1);
                    return;
                }
            ...
            // luodaan lista, josta etsitään tapahtumia
            Today app = new Today();
            app.addEvents();
            // väliaikainen lista, johon tallennetaan löydettyjä
